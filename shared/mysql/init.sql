...
-- Fri 08 Nov 2024 09:15:02 AM CST
...
-- Schema inmosoftDB
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `inmosoftDB` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci ;
USE `inmosoftDB` ;
...
CREATE TABLE IF NOT EXISTS `inmosoftDB`.`Propiedades` (
  ...
  `titulo` VARCHAR(45) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_spanish_ci' NULL,
  `fecha_alta` DATE NULL,
  `direccion` VARCHAR(45) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_spanish_ci' NULL,
