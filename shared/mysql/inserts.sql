...
(`id_propiedad`, `fecha_alta`, `direccion`, `colonia`, `ciudad`, `referencia`, `precio`, 
...
VALUES 
(1, '2024-10-11', 'Av. Principal 101', 'Centro', 'Saltillo', 'Frente al parque', 3500000, 
...
(`id_propiedad`, `fecha_alta`, `direccion`, `colonia`, `ciudad`, `referencia`, `precio`, 
 ...
 `extras`, `utilidades`, `observaciones`, `id_tipo_propiedad`, `id_propietario`, `id_usuario`)
VALUES 
(2, '2024-10-12', 'Calle Norte 202', 'Las Flores', 'Ramos', 'Cerca de la escuela', 1800000, 
...
(`id_propiedad`, `fecha_alta`, `direccion`, `colonia`, `ciudad`, `referencia`, `precio`, 
 ...
 `extras`, `utilidades`, `observaciones`, `id_tipo_propiedad`, `id_propietario`, `id_usuario`)
VALUES 
(3, '2024-10-13', 'Calle del Sol 303', 'Vista Hermosa', 'Saltillo', 'Cerca del centro', 2900000, 
...
(`id_propiedad`, `fecha_alta`, `direccion`, `colonia`, `ciudad`, `referencia`, `precio`, 
 ...
 `extras`, `utilidades`, `observaciones`, `id_tipo_propiedad`, `id_propietario`, `id_usuario`)
VALUES 
(4, '2024-10-14', 'Av. de la Paz 404', 'Granjas', 'Saltillo', 'Junto al mercado', 2200000, 
...
(`id_propiedad`, `fecha_alta`, `direccion`, `colonia`, `ciudad`, `referencia`, `precio`, 
 ...
 `extras`, `utilidades`, `observaciones`, `id_tipo_propiedad`, `id_propietario`, `id_usuario`)
VALUES 
(5, '2024-10-15', 'Calle Luna 505', 'San Ángel', 'Arteaga', 'Junto a la iglesia', 3200000, 
...
(`id_propiedad`, `fecha_alta`, `direccion`, `colonia`, `ciudad`, `referencia`, `precio`, 
 ...
 `extras`, `utilidades`, `observaciones`, `id_tipo_propiedad`, `id_propietario`, `id_usuario`)
VALUES 
(6, '2024-10-16', 'Calle Verde 606', 'Bosques', 'derramadero', 'A un lado del parque', 2600000, 
 190, 370, 1, 1, 2, 3, 2, 2, 60, 'natural', 'clima,aljibe', 
 'jardin,cuarto_servicio,techada', 'agua,luz,internet', 
 'Casa en excelente ubicación con cochera techada y amplio jardín', 1, 3, 3);
